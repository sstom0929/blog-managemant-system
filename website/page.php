...
<body>
   <div class="main">
       <div class="left">
           ...
           <ul class="child">
               <li class="now" id="all_page"><a href="page.php">全部頁面</a></li>
           </ul>
           <ul class="child">
               <li id="new_page"><a href="page.php?center_display=new_page">新增頁面</a></li>
           </ul>
           <ul class="parent">
       ...
       <div class="center">
           <?php
               if(isset($_GET["edit"]) && $_GET["edit"] == '1'){
                   ...
                   if(isset($_GET["center_display"]) && $_GET["center_display"] == 'new_page'){
                       include('newpage.php');
                   }
                   if(!isset($_GET["center_display"])){
                       include('allpage.php');
